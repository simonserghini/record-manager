          ...
          <div class="grid grid-cols-1 gap-6 mt-2">
            <div class="bg-slate-50 border border-slate-200 rounded-xl p-5">
              ...
              <div class="flex items-center gap-2">
                ...
                <button type="button" data-copy={redirectUri} title="Copy to clipboard" class="p-2 bg-slate-100 hover:bg-slate-200 text-slate-600 rounded-lg transition-colors">
